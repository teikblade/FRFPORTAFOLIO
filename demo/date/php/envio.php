...
//mysqli_query($conect,"SELECT * FROM sala WHERE user1 = '$usuario'");
...
<div class="text-left">
	...
	<div>
	<span class="btn bg-light"><?php echo $filaUser1['mensaje']; ?></span>
	<span><?php echo formatearFecha($filaUser1['fecha']); ?></span>
	</div>
</div>
<?php endwhile;
