...
<html>
	...
	<body class="container-fluid" onload="PerfilesDestacadosAjax('<?php echo $_SESSION['pais']?>','<?php echo $_SESSION['usuario']?>')">
		...
		<section class="container">
			...
			<div class='row perfiles-nuevos panel-menu-margin' id="perfilesDestacados"></div>
